    ...
    if choose == "Encode":
        ...
        if enc_button:
            if img_take is not None and text:
                ...
                with col2:
                    st.warning("Please upload an image or enter a message before encoding.")
        ...
        with col2:
            ...
            try:
                ...
                if dec_button:
                    ...
                    decoded_message = ImageSteganography.decode(img_array)
                
                    st.success("Message decoded successfully!")
                    st.text_area("Decoded Message:", value=decoded_message, height=150, disabled=True)
            except:
                st.warning("Please enter an image!")
